...
def predict():
	claimants=pd.read_csv(r"C:\Users\admin\Desktop\logistics\claimants.csv")
	...
	if request.method == 'POST':
		...
		ins = int(request.form['CLMINSUR'])
		seat = int(request.form['SEATBELT'])
		age = int(request.form['CLMAGE'])
