...
for i in range(1, 21):
  ip = []  
  url = "https://www.amazon.in/www.amazon.in-%E2%80%BA-Echo-show-5-Smart-speaker-with-5.5-screen-and-Alexa/product-reviews/B08KGVYX6F/ref=cm_cr_getr_d_paging_btm_next_3?ie=UTF8&reviewerType=all_reviews&pageNumber="+str(i)  
